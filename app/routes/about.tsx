  ...
  return (
      <div className='about-page'>
          ...
          <p>
              ...
              (HTML/CSS/JS). Over the course of an hour, you&#x27;ll transform a vinyl-record-themed website into a
              dynamic React app—learning components, JSX, hooks, and state along the way. You&#x27;ll walk away with a
              solid understanding of how React works and the grooves to get started building your own interactive UIs.
          </p>
          <p>
